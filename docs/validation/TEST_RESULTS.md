...
|---|---|
| Date | 2026-06-07 |
| Branch | `docs/issue-132-frontend-api-validation` |
...
| API-007 | API | `POST /api/scans/trigger` with JWT | 200 with scan result | Not tested | Pending | Requires valid JWT + Azure credentials | Run when backend available |
